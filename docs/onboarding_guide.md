...
| `index.html` | Статическая версия главного лендинга с секциями навигации, ролей, тарифов, витрины, FAQ и документов. |
| `assets/page-loader.js` | Клиентская утилита, которая подгружает общую навигацию/футер и нужный блок на отдельные страницы. |
| `pages/` | Набор HTML-страниц для раздельного просмотра секций (тарифы, роли, FAQ и др.), плюс обзор `sections.html`. |
...
> 🔀 **Раздельные страницы**. Помимо полного лендинга на `/`, в каталоге `pages/` доступны адреса `/pages/how.html`, `/pages/pricing.html`, `/pages/faq.html` и т.д. Навигационный пункт «Страницы» ведёт на обзор `/pages/sections.html`.
